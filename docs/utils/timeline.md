...
## Common Event Format
A super timeline using the [Common Event Format](https://www.microfocus.com/documentation/arcsight/arcsight-smartconnectors-8.3/cef-implementation-standard/Content/CEF/Chapter%201%20What%20is%20CEF.htm), can be created for [Linux Systemd Journals](../../files/logs/journal.md) or [Windows Event Logs](../../files/logs/evtx.md).
